...
function writeGameState() {
	document.getElementById("year").innerHTML = "Årsrapporten: " + gameState.year;
	document.getElementById("starved").innerHTML = "Svältade: " + gameState.starved;
	document.getElementById("newcomers").innerHTML = "Nykomlingar: " + gameState.newcomers;
	...
	document.getElementById("bushels").innerHTML = "Buskar: " + gameState.bushels;
